...
EMARKERSIZE = 60;       % default depends on number of electrodes, set in code
...
for kk = 1:numChanPairs
    han = plot3(y(displayStruct.chanPairs(kk, :)), x(displayStruct.chanPairs(kk, :)), [ELECTRODE_HEIGHT, ELECTRODE_HEIGHT], 'LineWidth', 4, 'Color', cM(cmapPos(kk), :));
end
